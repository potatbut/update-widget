...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"widget/widget.js":[function(require,module,exports) {
"use strict";
...
var template = function template() {
  ...
  var items = data.map(function (item) {
    return "\n      <div class=\"widget__notice notice update\" >\n      <div class=\"notice__title\" >\u0422\u0435\u043C\u0430: ".concat(item.title, "</div>\n      <div class=\"notice__author\">\u0410\u0432\u0442\u043E\u0440: ").concat(item.author, "</div>\n      <div class=\"notice__date-time\">\n        <div class=\"notice__date\">").concat(item.date, "</div>\n        <div class=\"notice__time\">").concat(item.time, "</div>\n      </div>\n      <div class=\"notice__more\"><a href=\"").concat(item.src, "\"> \u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435 </a> </div>\n      <div data-type=\"notice\" class=\"notice__check\" > \u041E\u0442\u043C\u0435\u0442\u0438\u0442\u044C \u043F\u0440\u043E\u0447\u0438\u0442\u0430\u043D\u043D\u044B\u043C </div>\n      \n    </div>\n    ");
  });
...
var Widget = /*#__PURE__*/function () {
  function Widget(selector) {
    ...
    _classPrivateMethodGet(this, _notice, _notice2).call(this);

    var notification = document.getElementsByClassName('update').length;
  ...
  _createClass(Widget, [{
    ...
    key: "clickNotice",
    value: function clickNotice(event) {
...
},{"./bundle-url":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"widget/styles.scss":[function(require,module,exports) {
...
require("./widget/styles.scss");

var widget = new _widget.Widget('#widget', {
  /* data: [
    {
      title: 'О котах',
      author: 'Иван Иванов',
...
},{"./widget/widget":"widget/widget.js","./widget/styles.scss":"widget/styles.scss"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/updates-widget.e31bb0bc.js.map